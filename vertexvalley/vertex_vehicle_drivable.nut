...
// old cantexit loc
		...
		// local weapon = GetActiveWeapon(driver);
		// if (weapon)
		// {
...
function GetActiveWeapon(handle) {
	return NetProps.GetPropEntity(handle, "m_hActiveWeapon")
}